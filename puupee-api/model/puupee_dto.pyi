...
class PuupeeDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "creationTime", "creatorId", "lastModificationTime", "lastModifierId", "isDeleted", "deleterId", "deletionTime", "name", "title", "description", "text", "format", "password", "parentId", "key", "url", "size", "md5", "sliceMd5", "rapidCode", "contentType", "type", "displayStyle", "extension", "storageClass", "storageObjectCreatedAt", "storageObjectUpdatedAt", "storageObjectId", "storageObject", "thumb", "priority", "doneAt", "isDone", "startAt", "endAt", "notifyAt", "notifyTimingType", "notifyTimingUnit", "notifyTimingValue", "repeat", "repeatOffAt", "repeatOffTimes", "syncVersion", "isHidden", "tagging", "lastModifierDeviceToken", "lastModifierDevice", ], str]):
