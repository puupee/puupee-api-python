...
class ExtensionPropertyUiFormDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["isVisible", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["isVisible", ], str]):
