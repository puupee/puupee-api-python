...
class CreateOrUpdateAppFeatureDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "displayName", "description", "details", "screenshotKeys", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "displayName", "description", "details", "screenshotKeys", ], str]):
