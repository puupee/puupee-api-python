        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['NotificationInfoDto']:
                        return NotificationInfoDto
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['NotificationInfoDto'], typing.List['NotificationInfoDto']],
                ...
                def __getitem__(self, i: int) -> 'NotificationInfoDto':
