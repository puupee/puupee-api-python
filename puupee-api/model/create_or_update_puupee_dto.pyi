...
class CreateOrUpdatePuupeeDto(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["pushToUser"]) -> MetaOapg.properties.pushToUser: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "title", "isHidden", "description", "text", "content", "format", "password", "parentId", "key", "md5", "sliceMd5", "rapidCode", "contentType", "type", "displayStyle", "extension", "storageClass", "storageObjectCreatedAt", "storageObjectUpdatedAt", "syncVersion", "isDeleted", "deletionTime", "creationTime", "lastModificationTime", "priority", "startAt", "endAt", "notifyAt", "notifyTimingType", "notifyTimingUnit", "notifyTimingValue", "repeat", "repeatOffAt", "repeatOffTimes", "repetitions", "isDone", "doneAt", "creatorId", "lastModifierId", "deleterId", "tagging", "url", "size", "lastModifierDeviceToken", "lastModifierDevice", "app", "pushToUser", "sortIndex", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["pushToUser"]) -> typing.Union[MetaOapg.properties.pushToUser, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        pushToUser: typing.Union[MetaOapg.properties.pushToUser, bool, schemas.Unset] = schemas.unset,
