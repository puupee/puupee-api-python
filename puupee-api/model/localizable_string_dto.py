...
class LocalizableStringDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "resource", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "resource", ], str]):
