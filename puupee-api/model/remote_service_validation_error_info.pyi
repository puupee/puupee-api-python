...
class RemoteServiceValidationErrorInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["message", "members", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["message", "members", ], str]):
