...
# body param
SchemaForRequestBodyApplicationJson = CreateOrUpdateAppPricingDto
SchemaForRequestBodyTextJson = CreateOrUpdateAppPricingDto
SchemaForRequestBodyApplicationJson = CreateOrUpdateAppPricingDto
...
SchemaFor200ResponseBodyTextPlain = AppPricingDto
SchemaFor200ResponseBodyApplicationJson = AppPricingDto
SchemaFor200ResponseBodyTextJson = AppPricingDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_app_app_pricing_id_put_oapg(
        self,
...
class ApiAppAppPricingIdPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_app_app_pricing_id_put(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def api_app_app_pricing_id_put(
        ...
        return self._api_app_app_pricing_id_put_oapg(
            body=body,
