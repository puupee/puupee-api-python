...
SchemaFor200ResponseBodyTextPlain = DecimalKeyValue
SchemaFor200ResponseBodyApplicationJson = DecimalKeyValue
SchemaFor200ResponseBodyTextJson = DecimalKeyValue
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_app_key_value_decimal_get_oapg(
        self,
...
class ApiAppKeyValueDecimalGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_app_key_value_decimal_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_app_key_value_decimal_get(
        ...
        return self._api_app_key_value_decimal_get_oapg(
