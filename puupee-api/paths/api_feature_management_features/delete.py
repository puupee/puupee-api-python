...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_feature_management_features_delete_oapg(
        self,
...
class ApiFeatureManagementFeaturesDelete(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_feature_management_features_delete(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_feature_management_features_delete(
        ...
        return self._api_feature_management_features_delete_oapg(
