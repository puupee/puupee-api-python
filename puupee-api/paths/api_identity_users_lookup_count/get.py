...
SchemaFor200ResponseBodyTextPlain = schemas.Int64Schema
SchemaFor200ResponseBodyApplicationJson = schemas.Int64Schema
SchemaFor200ResponseBodyTextJson = schemas.Int64Schema
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_identity_users_lookup_count_get_oapg(
        self,
...
class ApiIdentityUsersLookupCountGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_identity_users_lookup_count_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_identity_users_lookup_count_get(
        ...
        return self._api_identity_users_lookup_count_get_oapg(
