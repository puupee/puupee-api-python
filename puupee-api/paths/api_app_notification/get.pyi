...
SchemaFor200ResponseBodyTextPlain = NotificationInfoDtoPagedResultDto
SchemaFor200ResponseBodyApplicationJson = NotificationInfoDtoPagedResultDto
SchemaFor200ResponseBodyTextJson = NotificationInfoDtoPagedResultDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_app_notification_get_oapg(
        self,
...
class ApiAppNotificationGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_app_notification_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_app_notification_get(
        ...
        return self._api_app_notification_get_oapg(
