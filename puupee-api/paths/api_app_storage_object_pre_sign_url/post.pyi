...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_app_storage_object_pre_sign_url_post_oapg(
        self,
...
class ApiAppStorageObjectPreSignUrlPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_app_storage_object_pre_sign_url_post(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_app_storage_object_pre_sign_url_post(
        ...
        return self._api_app_storage_object_pre_sign_url_post_oapg(
