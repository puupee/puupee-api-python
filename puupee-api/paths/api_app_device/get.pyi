...
SchemaFor200ResponseBodyTextPlain = DeviceDtoPagedResultDto
SchemaFor200ResponseBodyApplicationJson = DeviceDtoPagedResultDto
SchemaFor200ResponseBodyTextJson = DeviceDtoPagedResultDto
...
class ApiAppDeviceGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_app_device_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_app_device_get(
        ...
        return self._api_app_device_get_oapg(
