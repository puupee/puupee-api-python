...
# Query params
AutomaticallyCopySchema = schemas.Int32Schema
CopySchema = schemas.StrSchema
UrlSchema = schemas.StrSchema
IsArchiveSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'automaticallyCopy': typing.Union[AutomaticallyCopySchema, decimal.Decimal, int, ],
        'copy': typing.Union[CopySchema, str, ],
        'url': typing.Union[UrlSchema, str, ],
        'isArchive': typing.Union[IsArchiveSchema, str, ],
...
request_query_automatically_copy = api_client.QueryParameter(
    name="automaticallyCopy",
    schema=AutomaticallyCopySchema,
)
request_query_copy = api_client.QueryParameter(
    name="copy",
    schema=CopySchema,
)
...
request_query_is_archive = api_client.QueryParameter(
    name="isArchive",
    schema=IsArchiveSchema,
)
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'message': typing.Union[MessageSchema, str, ],
    }
)
...
request_path_api_key = api_client.PathParameter(
    name="apiKey",
    schema=ApiKeySchema,
    required=True,
)
request_path_message = api_client.PathParameter(
    name="message",
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_app_notification_bark_api_key_message_get_oapg(
        self,
    ...
    def _api_app_notification_bark_api_key_message_get_oapg(
        ...
        for parameter in (
            request_query_automatically_copy,
            request_query_copy,
            request_query_url,
            request_query_is_archive,
            request_query_group,
            request_query_icon,
            request_query_name,
            request_query_value,
...
class ApiAppNotificationBarkApiKeyMessageGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_app_notification_bark_api_key_message_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def api_app_notification_bark_api_key_message_get(
        ...
        return self._api_app_notification_bark_api_key_message_get_oapg(
