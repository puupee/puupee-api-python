...
# body param
SchemaForRequestBodyApplicationJson = CreateOrUpdateAppFeatureDto
SchemaForRequestBodyTextJson = CreateOrUpdateAppFeatureDto
SchemaForRequestBodyApplicationJson = CreateOrUpdateAppFeatureDto
...
SchemaFor200ResponseBodyTextPlain = AppFeatureDto
SchemaFor200ResponseBodyApplicationJson = AppFeatureDto
SchemaFor200ResponseBodyTextJson = AppFeatureDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_app_app_feature_id_put_oapg(
        self,
...
class ApiAppAppFeatureIdPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_app_app_feature_id_put(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def api_app_app_feature_id_put(
        ...
        return self._api_app_app_feature_id_put_oapg(
            body=body,
