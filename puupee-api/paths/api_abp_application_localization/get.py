...
# Query params
CultureNameSchema = schemas.StrSchema
OnlyDynamicsSchema = schemas.BoolSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'CultureName': typing.Union[CultureNameSchema, str, ],
    }
)
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        'OnlyDynamics': typing.Union[OnlyDynamicsSchema, bool, ],
    },
    total=False
)
...
request_query_culture_name = api_client.QueryParameter(
    name="CultureName",
    schema=CultureNameSchema,
    required=True,
)
request_query_only_dynamics = api_client.QueryParameter(
    name="OnlyDynamics",
    schema=OnlyDynamicsSchema,
)
_auth = [
    'oauth2',
]
SchemaFor200ResponseBodyTextPlain = ApplicationLocalizationDto
SchemaFor200ResponseBodyApplicationJson = ApplicationLocalizationDto
SchemaFor200ResponseBodyTextJson = ApplicationLocalizationDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_abp_application_localization_get_oapg(
        self,
    ...
    def _api_abp_application_localization_get_oapg(
        ...
        for parameter in (
            request_query_culture_name,
            request_query_only_dynamics,
        ):
...
class ApiAbpApplicationLocalizationGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_abp_application_localization_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_abp_application_localization_get(
        ...
        return self._api_abp_application_localization_get_oapg(
