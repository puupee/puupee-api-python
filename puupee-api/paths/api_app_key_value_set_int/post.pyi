...
# body param
SchemaForRequestBodyApplicationJson = Int32SetKeyValueDto
SchemaForRequestBodyTextJson = Int32SetKeyValueDto
SchemaForRequestBodyApplicationJson = Int32SetKeyValueDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_app_key_value_set_int_post_oapg(
        self,
...
class ApiAppKeyValueSetIntPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_app_key_value_set_int_post(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def api_app_key_value_set_int_post(
        ...
        return self._api_app_key_value_set_int_post_oapg(
            body=body,
