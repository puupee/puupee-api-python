...
# Query params
CreatorIdSchema = schemas.UUIDSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'CreatorId': typing.Union[CreatorIdSchema, str, uuid.UUID, ],
...
request_query_creator_id = api_client.QueryParameter(
    name="CreatorId",
...
class ApiAppAppGet(BaseApi):
    ...
    def api_app_app_get(
        ...
        return self._api_app_app_get_oapg(
