...
SchemaFor200ResponseBodyTextPlain = AppPricingDtoPagedResultDto
SchemaFor200ResponseBodyApplicationJson = AppPricingDtoPagedResultDto
SchemaFor200ResponseBodyTextJson = AppPricingDtoPagedResultDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_app_app_pricing_get_oapg(
        self,
...
class ApiAppAppPricingGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_app_app_pricing_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_app_app_pricing_get(
        ...
        return self._api_app_app_pricing_get_oapg(
