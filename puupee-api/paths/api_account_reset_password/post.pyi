...
# body param
SchemaForRequestBodyApplicationJson = ResetPasswordDto
SchemaForRequestBodyTextJson = ResetPasswordDto
SchemaForRequestBodyApplicationJson = ResetPasswordDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_account_reset_password_post_oapg(
        self,
...
class ApiAccountResetPasswordPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_account_reset_password_post(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def api_account_reset_password_post(
        ...
        return self._api_account_reset_password_post_oapg(
            body=body,
