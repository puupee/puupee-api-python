...
# Query params
CollectionSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'Collection': typing.Union[CollectionSchema, str, ],
...
request_query_collection = api_client.QueryParameter(
    name="Collection",
...
SchemaFor200ResponseBodyTextPlain = SimpleDataDtoPagedResultDto
SchemaFor200ResponseBodyApplicationJson = SimpleDataDtoPagedResultDto
SchemaFor200ResponseBodyTextJson = SimpleDataDtoPagedResultDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_app_simple_data_get_oapg(
        self,
...
class ApiAppSimpleDataGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_app_simple_data_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_app_simple_data_get(
        ...
        return self._api_app_simple_data_get_oapg(
