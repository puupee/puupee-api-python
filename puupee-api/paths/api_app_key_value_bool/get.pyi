...
SchemaFor200ResponseBodyTextPlain = BooleanKeyValue
SchemaFor200ResponseBodyApplicationJson = BooleanKeyValue
SchemaFor200ResponseBodyTextJson = BooleanKeyValue
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_app_key_value_bool_get_oapg(
        self,
...
class ApiAppKeyValueBoolGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_app_key_value_bool_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_app_key_value_bool_get(
        ...
        return self._api_app_key_value_bool_get_oapg(
