...
# body param
SchemaForRequestBodyApplicationJson = BooleanSetKeyValueDto
SchemaForRequestBodyTextJson = BooleanSetKeyValueDto
SchemaForRequestBodyApplicationJson = BooleanSetKeyValueDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_app_key_value_set_bool_post_oapg(
        self,
...
class ApiAppKeyValueSetBoolPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_app_key_value_set_bool_post(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def api_app_key_value_set_bool_post(
        ...
        return self._api_app_key_value_set_bool_post_oapg(
            body=body,
