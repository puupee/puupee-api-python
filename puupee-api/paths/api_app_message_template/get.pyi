...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['MessageTemplateDto']:
            return MessageTemplateDto

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['MessageTemplateDto'], typing.List['MessageTemplateDto']],
    ...
    def __getitem__(self, i: int) -> 'MessageTemplateDto':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_app_message_template_get_oapg(
        self,
...
class ApiAppMessageTemplateGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_app_message_template_get(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def api_app_message_template_get(
        ...
        return self._api_app_message_template_get_oapg(
