...
SchemaFor200ResponseBodyTextPlain = Int32KeyValue
SchemaFor200ResponseBodyApplicationJson = Int32KeyValue
SchemaFor200ResponseBodyTextJson = Int32KeyValue
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_app_key_value_int_get_oapg(
        self,
...
class ApiAppKeyValueIntGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_app_key_value_int_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_app_key_value_int_get(
        ...
        return self._api_app_key_value_int_get_oapg(
