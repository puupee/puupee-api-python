...
SchemaFor200ResponseBodyTextPlain = SettingsDto
SchemaFor200ResponseBodyApplicationJson = SettingsDto
SchemaFor200ResponseBodyTextJson = SettingsDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_app_settings_get_oapg(
        self,
...
class ApiAppSettingsGet(BaseApi):
    ...
    def api_app_settings_get(
        ...
        return self._api_app_settings_get_oapg(
