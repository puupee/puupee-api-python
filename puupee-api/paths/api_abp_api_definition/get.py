...
# Query params
IncludeTypesSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'IncludeTypes': typing.Union[IncludeTypesSchema, bool, ],
    },
    total=False
)
...
request_query_include_types = api_client.QueryParameter(
    name="IncludeTypes",
    schema=IncludeTypesSchema,
)
_auth = [
    'oauth2',
]
SchemaFor200ResponseBodyTextPlain = ApplicationApiDescriptionModel
SchemaFor200ResponseBodyApplicationJson = ApplicationApiDescriptionModel
SchemaFor200ResponseBodyTextJson = ApplicationApiDescriptionModel
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_abp_api_definition_get_oapg(
        self,
...
class ApiAbpApiDefinitionGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_abp_api_definition_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_abp_api_definition_get(
        ...
        return self._api_abp_api_definition_get_oapg(
