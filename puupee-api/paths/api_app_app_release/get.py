...
PlatformNameSchema = schemas.StrSchema
PlatformValueSchema = schemas.StrSchema
SortingSchema = schemas.StrSchema


class SkipCountSchema(
    schemas.Int32Schema
):
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'AppId': typing.Union[AppIdSchema, str, uuid.UUID, ],
        'Environment': typing.Union[EnvironmentSchema, str, ],
        'Platform.Name': typing.Union[PlatformNameSchema, str, ],
        'Platform.Value': typing.Union[PlatformValueSchema, str, ],
        'Sorting': typing.Union[SortingSchema, str, ],
        'SkipCount': typing.Union[SkipCountSchema, decimal.Decimal, int, ],
        'MaxResultCount': typing.Union[MaxResultCountSchema, decimal.Decimal, int, ],
    },
    total=False
)
...
request_query_platform_name = api_client.QueryParameter(
    name="Platform.Name",
    schema=PlatformNameSchema,
)
request_query_platform_value = api_client.QueryParameter(
    name="Platform.Value",
    schema=PlatformValueSchema,
)
request_query_sorting = api_client.QueryParameter(
    name="Sorting",
...
request_query_max_result_count = api_client.QueryParameter(
    name="MaxResultCount",
...
SchemaFor200ResponseBodyTextPlain = AppReleaseDtoPagedResultDto
SchemaFor200ResponseBodyApplicationJson = AppReleaseDtoPagedResultDto
SchemaFor200ResponseBodyTextJson = AppReleaseDtoPagedResultDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_app_app_release_get_oapg(
        self,
    ...
    def _api_app_app_release_get_oapg(
        ...
        for parameter in (
            ...
            request_query_platform_name,
            request_query_platform_value,
            request_query_sorting,
            request_query_skip_count,
            request_query_max_result_count,
        ):
...
class ApiAppAppReleaseGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_app_app_release_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_app_app_release_get(
        ...
        return self._api_app_app_release_get_oapg(
