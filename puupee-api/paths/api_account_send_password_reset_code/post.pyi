...
# body param
SchemaForRequestBodyApplicationJson = SendPasswordResetCodeDto
SchemaForRequestBodyTextJson = SendPasswordResetCodeDto
SchemaForRequestBodyApplicationJson = SendPasswordResetCodeDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_account_send_password_reset_code_post_oapg(
        self,
...
class ApiAccountSendPasswordResetCodePost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_account_send_password_reset_code_post(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def api_account_send_password_reset_code_post(
        ...
        return self._api_account_send_password_reset_code_post_oapg(
            body=body,
