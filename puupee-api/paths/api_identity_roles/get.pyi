...
SchemaFor200ResponseBodyTextPlain = IdentityRoleDtoPagedResultDto
SchemaFor200ResponseBodyApplicationJson = IdentityRoleDtoPagedResultDto
SchemaFor200ResponseBodyTextJson = IdentityRoleDtoPagedResultDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_identity_roles_get_oapg(
        self,
...
class ApiIdentityRolesGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_identity_roles_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_identity_roles_get(
        ...
        return self._api_identity_roles_get_oapg(
