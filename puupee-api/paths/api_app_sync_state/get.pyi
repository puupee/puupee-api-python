...
SchemaFor200ResponseBodyTextPlain = SyncStateDto
SchemaFor200ResponseBodyApplicationJson = SyncStateDto
SchemaFor200ResponseBodyTextJson = SyncStateDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_app_sync_state_get_oapg(
        self,
...
class ApiAppSyncStateGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_app_sync_state_get(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def api_app_sync_state_get(
        ...
        return self._api_app_sync_state_get_oapg(
