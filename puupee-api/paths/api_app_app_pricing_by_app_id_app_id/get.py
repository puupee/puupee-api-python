...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['AppPricingDto']:
            return AppPricingDto

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['AppPricingDto'], typing.List['AppPricingDto']],
    ...
    def __getitem__(self, i: int) -> 'AppPricingDto':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_app_app_pricing_by_app_id_app_id_get_oapg(
        self,
...
class ApiAppAppPricingByAppIdAppIdGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_app_app_pricing_by_app_id_app_id_get(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_app_app_pricing_by_app_id_app_id_get(
        ...
        return self._api_app_app_pricing_by_app_id_app_id_get_oapg(
