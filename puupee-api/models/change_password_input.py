...
class ChangePasswordInput(object):
    ...
    def current_password(self, current_password):
        ...
        if (self.local_vars_configuration.client_side_validation and
                current_password is not None and len(current_password) > 128):
            raise ValueError("Invalid value for `current_password`, length must be less than or equal to `128`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                current_password is not None and len(current_password) < 0):
            raise ValueError("Invalid value for `current_password`, length must be greater than or equal to `0`")  # noqa: E501
    ...
    def new_password(self, new_password):
        ...
        if (self.local_vars_configuration.client_side_validation and
                new_password is not None and len(new_password) < 0):
