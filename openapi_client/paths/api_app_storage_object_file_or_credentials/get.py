...
# Query params
RapidCodeSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'rapidCode': typing.Union[RapidCodeSchema, str, ],
...
request_query_rapid_code = api_client.QueryParameter(
    name="rapidCode",
    schema=RapidCodeSchema,
)
...
SchemaFor200ResponseBodyTextPlain = StorageObjectOrCredentialsDto
SchemaFor200ResponseBodyApplicationJson = StorageObjectOrCredentialsDto
SchemaFor200ResponseBodyTextJson = StorageObjectOrCredentialsDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_app_storage_object_file_or_credentials_get_oapg(
        self,
...
class ApiAppStorageObjectFileOrCredentialsGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_app_storage_object_file_or_credentials_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_app_storage_object_file_or_credentials_get(
        ...
        return self._api_app_storage_object_file_or_credentials_get_oapg(
