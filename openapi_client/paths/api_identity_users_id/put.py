...
# body param
SchemaForRequestBodyApplicationJson = IdentityUserUpdateDto
SchemaForRequestBodyTextJson = IdentityUserUpdateDto
SchemaForRequestBodyApplicationJson = IdentityUserUpdateDto
...
SchemaFor200ResponseBodyTextPlain = IdentityUserDto
SchemaFor200ResponseBodyApplicationJson = IdentityUserDto
SchemaFor200ResponseBodyTextJson = IdentityUserDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_identity_users_id_put_oapg(
        self,
...
class ApiIdentityUsersIdPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_identity_users_id_put(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def api_identity_users_id_put(
        ...
        return self._api_identity_users_id_put_oapg(
            body=body,
