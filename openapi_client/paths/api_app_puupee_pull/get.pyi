...
# Query params
AfterVersionSchema = schemas.Int64Schema
SkipCountSchema = schemas.Int32Schema
MaxResultCountSchema = schemas.Int32Schema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'afterVersion': typing.Union[AfterVersionSchema, decimal.Decimal, int, ],
...
request_query_after_version = api_client.QueryParameter(
    name="afterVersion",
    schema=AfterVersionSchema,
)
...
SchemaFor200ResponseBodyTextPlain = PuupeeDtoPagedResultDto
SchemaFor200ResponseBodyApplicationJson = PuupeeDtoPagedResultDto
SchemaFor200ResponseBodyTextJson = PuupeeDtoPagedResultDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_app_puupee_pull_get_oapg(
        self,
...
class ApiAppPuupeePullGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_app_puupee_pull_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_app_puupee_pull_get(
        ...
        return self._api_app_puupee_pull_get_oapg(
