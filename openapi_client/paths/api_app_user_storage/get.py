...
SchemaFor200ResponseBodyTextPlain = UserStorageDto
SchemaFor200ResponseBodyApplicationJson = UserStorageDto
SchemaFor200ResponseBodyTextJson = UserStorageDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_app_user_storage_get_oapg(
        self,
...
class ApiAppUserStorageGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_app_user_storage_get(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def api_app_user_storage_get(
        ...
        return self._api_app_user_storage_get_oapg(
