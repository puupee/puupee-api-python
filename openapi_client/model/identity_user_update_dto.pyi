...
class IdentityUserUpdateDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["userName", "email", "extraProperties", "name", "surname", "phoneNumber", "isActive", "lockoutEnabled", "roleNames", "password", "concurrencyStamp", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["userName", "email", "extraProperties", "name", "surname", "phoneNumber", "isActive", "lockoutEnabled", "roleNames", "password", "concurrencyStamp", ], str]):
        return super().get_item_oapg(name)
