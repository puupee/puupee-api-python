...
class CreateOrUpdateAppDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "displayName", "framework", "appType", "description", "icon", "gitRepository", "gitRepositoryType", "features", "sdks", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "displayName", "framework", "appType", "description", "icon", "gitRepository", "gitRepositoryType", "features", "sdks", ], str]):
