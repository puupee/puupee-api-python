...
class CreateOrUpdateAppUserScoreDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["appId", "score", "comment", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["appId", "score", "comment", ], str]):
