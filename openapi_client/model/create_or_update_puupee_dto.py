...
class CreateOrUpdatePuupeeDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "title", "isHidden", "description", "text", "format", "password", "parentId", "key", "md5", "sliceMd5", "rapidCode", "contentType", "type", "displayStyle", "extension", "storageClass", "storageObjectCreatedAt", "storageObjectUpdatedAt", "syncVersion", "isDeleted", "deletionTime", "creationTime", "lastModificationTime", "priority", "startAt", "endAt", "notifyAt", "notifyTimingType", "notifyTimingUnit", "notifyTimingValue", "repeat", "repeatOffAt", "repeatOffTimes", "isDone", "doneAt", "creatorId", "lastModifierId", "deleterId", "tagging", "url", "size", "lastModifierDeviceToken", "lastModifierDevice", ], str]):
