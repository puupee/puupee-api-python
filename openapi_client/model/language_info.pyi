...
class LanguageInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["cultureName", "uiCultureName", "displayName", "flagIcon", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["cultureName", "uiCultureName", "displayName", "flagIcon", ], str]):
