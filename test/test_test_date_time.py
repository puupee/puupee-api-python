...
import puupee-api
from puupee-api.models.test_date_time import TestDateTime  # noqa: E501
...
class TestTestDateTime(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = puupee-api.models.test_date_time.TestDateTime()  # noqa: E501
        if include_optional :
            return TestDateTime(
                created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                puupee = puupee-api.models.puupee_dto.PuupeeDto(
                    id = '', 
