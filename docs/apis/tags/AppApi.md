...
[**api_app_app_id_public_get**](#api_app_app_id_public_get) | **get** /api/app/app/{id}/public | 
...
# **api_app_app_id_public_get**
<a name="api_app_app_id_public_get"></a>
> PublicAppDto api_app_app_id_public_get(id)
...
with puupee-api.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.api_app_app_id_public_get(
            path_params=path_params,
        )
        pprint(api_response)
    except puupee-api.ApiException as e:
        print("Exception when calling AppApi->api_app_app_id_public_get: %s\n" % e)
```
### Parameters
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#api_app_app_id_public_get.ApiResponseFor200) | Success
403 | [ApiResponseFor403](#api_app_app_id_public_get.ApiResponseFor403) | Forbidden
401 | [ApiResponseFor401](#api_app_app_id_public_get.ApiResponseFor401) | Unauthorized
400 | [ApiResponseFor400](#api_app_app_id_public_get.ApiResponseFor400) | Bad Request
404 | [ApiResponseFor404](#api_app_app_id_public_get.ApiResponseFor404) | Not Found
501 | [ApiResponseFor501](#api_app_app_id_public_get.ApiResponseFor501) | Server Error
500 | [ApiResponseFor500](#api_app_app_id_public_get.ApiResponseFor500) | Server Error

#### api_app_app_id_public_get.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor200ResponseBodyTextPlain, SchemaFor200ResponseBodyApplicationJson, SchemaFor200ResponseBodyTextJson, ] |  |
...
Type | Description  | Notes
------------- | ------------- | -------------
[**PublicAppDto**](../../models/PublicAppDto.md) |  | 
...
#### api_app_app_id_public_get.ApiResponseFor403
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor403ResponseBodyTextPlain, SchemaFor403ResponseBodyApplicationJson, SchemaFor403ResponseBodyTextJson, ] |  |
...
#### api_app_app_id_public_get.ApiResponseFor401
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor401ResponseBodyTextPlain, SchemaFor401ResponseBodyApplicationJson, SchemaFor401ResponseBodyTextJson, ] |  |
...
#### api_app_app_id_public_get.ApiResponseFor400
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor400ResponseBodyTextPlain, SchemaFor400ResponseBodyApplicationJson, SchemaFor400ResponseBodyTextJson, ] |  |
...
#### api_app_app_id_public_get.ApiResponseFor404
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor404ResponseBodyTextPlain, SchemaFor404ResponseBodyApplicationJson, SchemaFor404ResponseBodyTextJson, ] |  |
...
#### api_app_app_id_public_get.ApiResponseFor501
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor501ResponseBodyTextPlain, SchemaFor501ResponseBodyApplicationJson, SchemaFor501ResponseBodyTextJson, ] |  |
...
#### api_app_app_id_public_get.ApiResponseFor500
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor500ResponseBodyTextPlain, SchemaFor500ResponseBodyApplicationJson, SchemaFor500ResponseBodyTextJson, ] |  |
