<a name="__pageTop"></a>
# puupee-api.apis.tags.account_api.AccountApi
...
[**api_app_account_delete**](#api_app_account_delete) | **delete** /api/app/account | 
...
```python
import puupee-api
from puupee-api.apis.tags import account_api
...
<a name="api_app_account_delete"></a>
> api_app_account_delete()
...
with puupee-api.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.api_app_account_delete()
    except puupee-api.ApiException as e:
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#api_app_account_delete.ApiResponseFor200) | Success
403 | [ApiResponseFor403](#api_app_account_delete.ApiResponseFor403) | Forbidden
401 | [ApiResponseFor401](#api_app_account_delete.ApiResponseFor401) | Unauthorized
400 | [ApiResponseFor400](#api_app_account_delete.ApiResponseFor400) | Bad Request
404 | [ApiResponseFor404](#api_app_account_delete.ApiResponseFor404) | Not Found
501 | [ApiResponseFor501](#api_app_account_delete.ApiResponseFor501) | Server Error
500 | [ApiResponseFor500](#api_app_account_delete.ApiResponseFor500) | Server Error

#### api_app_account_delete.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[] |  |
...
#### api_app_account_delete.ApiResponseFor403
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor403ResponseBodyTextPlain, SchemaFor403ResponseBodyApplicationJson, SchemaFor403ResponseBodyTextJson, ] |  |
...
#### api_app_account_delete.ApiResponseFor401
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor401ResponseBodyTextPlain, SchemaFor401ResponseBodyApplicationJson, SchemaFor401ResponseBodyTextJson, ] |  |
...
#### api_app_account_delete.ApiResponseFor400
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor400ResponseBodyTextPlain, SchemaFor400ResponseBodyApplicationJson, SchemaFor400ResponseBodyTextJson, ] |  |
...
#### api_app_account_delete.ApiResponseFor404
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor404ResponseBodyTextPlain, SchemaFor404ResponseBodyApplicationJson, SchemaFor404ResponseBodyTextJson, ] |  |
...
#### api_app_account_delete.ApiResponseFor501
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor501ResponseBodyTextPlain, SchemaFor501ResponseBodyApplicationJson, SchemaFor501ResponseBodyTextJson, ] |  |
...
#### api_app_account_delete.ApiResponseFor500
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor500ResponseBodyTextPlain, SchemaFor500ResponseBodyApplicationJson, SchemaFor500ResponseBodyTextJson, ] |  |
